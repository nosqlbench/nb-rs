...
use nbrs_variates::nodes::arithmetic::{
    AddU64, DivU64, Interleave, MixedRadix, ModU64,
};
use nbrs_variates::nodes::hash::{Hash64, HashRange};
...
fn build_hello_world() -> nbrs_variates::kernel::GkKernel {
...
fn build_cartesian_space() -> nbrs_variates::kernel::GkKernel {
    let mut asm = GkAssembler::new(vec!["cycle".into()]);
...
fn build_shared_computation() -> nbrs_variates::kernel::GkKernel {
    let mut asm = GkAssembler::new(vec!["cycle".into()]);
...
fn build_multi_coordinate() -> nbrs_variates::kernel::GkKernel {
...
fn build_hashing_provenance() -> nbrs_variates::kernel::GkKernel {
    let mut asm = GkAssembler::new(vec!["cycle".into()]);
...
fn build_timeseries() -> nbrs_variates::kernel::GkKernel {
    let mut asm = GkAssembler::new(vec!["cycle".into()]);
