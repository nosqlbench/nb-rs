...
//!
//! These tests cross crate boundaries (nbrs-metrics ↔ nbrs-variates)
...
use nbrs_variates::node::{GkNode, Value};
use nbrs_variates::nodes::param_helpers::{
    InRangeU64, IsPositiveU64, RequiredU64, ThisOrU64,
};
use nbrs_variates::nodes::runtime_context::{
