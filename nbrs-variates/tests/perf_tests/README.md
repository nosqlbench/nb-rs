...
nbrs bench gk "nbrs-variates/tests/perf_tests/*.gk" --compare iters=5

# Single scenario
nbrs bench gk nbrs-variates/tests/perf_tests/a2_stable_params.gk --compare iters=7

# Without provenance (raw engine baseline)
nbrs bench gk nbrs-variates/tests/perf_tests/a1_single_input.gk --no-provenance iters=5

# With flamegraph profiling
nbrs bench gk nbrs-variates/tests/perf_tests/c5_multi_root.gk --profile
```
