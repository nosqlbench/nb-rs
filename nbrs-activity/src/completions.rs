...
//!
//! Every persona (nbrs, nbrs, …) accepts the same core shape on
...
//!
//! ```ignore
//! let spec = nbrs_activity::completions::CompletionSpec {
//!     binary_name: "nbrs",
//!     subcommands: &["run", "completions"],
//!     run_params: nbrs_activity::runner::KNOWN_PARAMS,
//! };
//! if nbrs_activity::completions::handle_if_match(&spec, &args) {
//!     return;
//! }
//! ```
//!
...
pub struct CompletionSpec {
    /// Binary basename as invoked on the command line (e.g., `"nbrs"`).
