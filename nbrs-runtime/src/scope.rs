...
/// nbrs-runtime's text-level scope assembly cares about.
///
...
pub fn build_phase_scope_kernel(
    ...
    if std::env::var("NBRS_DEBUG_SCOPE_SYNTH")
        .map(|v| v == "1")
        .unwrap_or(false)
    {
        eprintln!(
...
"#;
    ...
    fn build_phase_scope_kernel_with_mod_in_binding_over_partition_iter_var() {
        ...
        let phase_bindings =
            nbrs_workload::model::BindingsDef::PolydatSource("n := mod_in(cycle, p)\n".to_string());
