...
//!
//! ```text
//! cargo bench -p nbrs-metrics --bench instruments -- counter
//! cargo bench -p nbrs-metrics --bench instruments -- 'timer/16'
//! ```
...
fn bench_live_window(c: &mut Criterion) {
    use nbrs_metrics::summaries::live_window::LiveWindowConfig;
