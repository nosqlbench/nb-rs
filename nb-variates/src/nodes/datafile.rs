...
pub fn signatures() -> &'static [FuncSig] {
    ...
    &[
        FuncSig {
            ...
            params: &[
                ParamSpec { name: "ordinal", slot_type: SlotType::Wire, required: true },
                ParamSpec { name: "filename", slot_type: SlotType::ConstStr, required: true },
                ParamSpec { name: "column", slot_type: SlotType::ConstStr, required: true },
            ],
            arity: Arity::Fixed,
        ...
        FuncSig {
            ...
            params: &[
                ParamSpec { name: "ordinal", slot_type: SlotType::Wire, required: true },
                ParamSpec { name: "filename", slot_type: SlotType::ConstStr, required: true },
                ParamSpec { name: "path", slot_type: SlotType::ConstStr, required: true },
            ],
            arity: Arity::Fixed,
            commutativity: crate::node::Commutativity::Positional,
