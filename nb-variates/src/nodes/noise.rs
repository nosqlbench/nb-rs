    ...
    &[
        FuncSig {
            ...
            params: &[
                ...
                ParamSpec { name: "frequency", slot_type: SlotType::ConstF64, required: true, example: "1.0" },
            ],
            arity: Arity::Fixed,
        ...
        FuncSig {
            ...
            params: &[
                ...
                ParamSpec { name: "seed", slot_type: SlotType::ConstU64, required: true, example: "42" },
                ParamSpec { name: "frequency", slot_type: SlotType::ConstF64, required: true, example: "1.0" },
                ParamSpec { name: "octaves", slot_type: SlotType::ConstU64, required: false, example: "4" },
            ],
            arity: Arity::Fixed,
            commutativity: crate::node::Commutativity::Positional,
