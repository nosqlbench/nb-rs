    ...
    &[
        FuncSig {
            ...
            params: &[
                ...
                ParamSpec { name: "seed", slot_type: SlotType::ConstU64, required: true, example: "42" },
                ParamSpec { name: "stream", slot_type: SlotType::ConstU64, required: true, example: "42" },
            ],
            arity: Arity::Fixed,
        ...
        FuncSig {
            ...
            params: &[
                ParamSpec { name: "input", slot_type: SlotType::Wire, required: true, example: "cycle" },
                ParamSpec { name: "stream", slot_type: SlotType::Wire, required: true, example: "cycle" },
                ParamSpec { name: "seed", slot_type: SlotType::ConstU64, required: true, example: "42" },
            ],
            arity: Arity::Fixed,
            commutativity: crate::node::Commutativity::Positional,
        ...
        FuncSig {
            ...
            params: &[
                ParamSpec { name: "input", slot_type: SlotType::Wire, required: true, example: "cycle" },
                ParamSpec { name: "min", slot_type: SlotType::ConstU64, required: false, example: "100" },
