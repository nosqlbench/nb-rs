...
pub fn signatures() -> &'static [FuncSig] {
    ...
    &[
        FuncSig {
            ...
            params: &[
                ParamSpec { name: "mean", slot_type: SlotType::ConstF64, required: true, example: "0.0" },
                ParamSpec { name: "stddev", slot_type: SlotType::ConstF64, required: true, example: "1.0" },
            ],
            arity: Arity::Fixed,
        ...
        FuncSig {
            ...
            identity: None, variadic_ctor: None,
            params: &[
                ParamSpec { name: "rate", slot_type: SlotType::ConstF64, required: true, example: "1.0" },
            ],
            arity: Arity::Fixed,
            commutativity: crate::node::Commutativity::Positional,
        ...
        FuncSig {
            ...
            identity: None, variadic_ctor: None,
            params: &[
                ParamSpec { name: "scale", slot_type: SlotType::ConstF64, required: true, example: "1.0" },
                ParamSpec { name: "shape", slot_type: SlotType::ConstF64, required: true, example: "2.0" },
            ],
            arity: Arity::Fixed,
            commutativity: crate::node::Commutativity::Positional,
        ...
        FuncSig {
            ...
            params: &[
                ...
                ParamSpec { name: "exponent", slot_type: SlotType::ConstF64, required: true, example: "1.5" },
            ],
            arity: Arity::Fixed,
            commutativity: crate::node::Commutativity::Positional,
        ...
        FuncSig {
            ...
            params: &[
                ParamSpec { name: "input", slot_type: SlotType::Wire, required: true, example: "cycle" },
                ParamSpec { name: "data", slot_type: SlotType::ConstStr, required: true, example: "\"1:10,2:20,3:30\"" },
            ],
            arity: Arity::Fixed,
            commutativity: crate::node::Commutativity::Positional,
