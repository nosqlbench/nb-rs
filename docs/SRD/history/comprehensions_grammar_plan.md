...
- [SRD 18e — Comprehension Canonical Reference](../18e_comprehension_canonical_reference.md)
...
- [SRD 18b](../18b_scenario_tree_and_scheduler.md)
  — execution plumbing
- [SRD 18c](../18c_comprehension_syntax.md) — user-
  facing syntax
- [SRD 18d](../18d_comprehension_traversal_order.md)
  — order taxonomy
