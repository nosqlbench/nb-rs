...
canonical SRDs first: `docs/SRD/82_uniform_execution_shells.md`, `83_stop_conditions.md`,
...
- SRDs: `docs/SRD/82_uniform_execution_shells.md`, `83_stop_conditions.md` (the `each:`
