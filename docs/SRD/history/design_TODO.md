* [x] Add bundled workloads — SRD-85 SHIPPED 
  * docs/SRD/85_bundled_workloads.md: embedded catalog, describe workloads, copy, extends-through-catalog
...
* (3) incorporate (standardize) JSON serdes standard types and into template 
  forms
* (3) audit docs
