...
2. [SRD-80b](../80b_macro_universal_authoring.md) §"Migration
...
- Update `docs/SRD/12_polydat_stdlib.md` (or its successor)
...
4. **Documentation update cadence.** SRD-80b is the
   ...
   currently lives in `docs/SRD/12_polydat_stdlib.md` (and
