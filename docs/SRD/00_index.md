...
| 08 | [MetricsQL — Contract & Axioms](08_metricsql.md) | **Front door** for nbrs-metricsql (standalone): parse/eval API + pluggable `DataSource`; Q-axioms (standalone, storage-as-a-service, streaming≡batch) |
