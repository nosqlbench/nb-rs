...
| 11 | [GK Evaluation Model](11_gk_evaluation.md) | Kernel/state split, input spaces, two lifecycles (effectively-const / dynamic), provenance-based invalidation, const-binding contract |
