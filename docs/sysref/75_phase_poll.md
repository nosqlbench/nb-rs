...
- `docs/sysref/47_metricsql_streaming.md` — evaluator
  algebra Option B will sit on.
- `docs/sysref/48_metricsql_continuous_query.md` —
  runtime path for `until_metricsql:`.
- `docs/sysref/73_op_field_modifiers.md` — the
  `on_timeout: accept` modifier shipped in P2 fits
  this taxonomy (HTTP-adapter, fire-and-yield).
- `docs/sysref/70_capture_paths.md` — JSON-Pointer
