...
| **`GkKernel::from_program(Arc<GkProgram>)` is the cache-and-rebind primitive.** Compile once, instantiate fresh per execution context. Documented for SRD-18b. | `polydat::kernel::gkkernel` (docstring) |
